...
-- Step 6: Update class enrollment count
UPDATE Bellini.Class
SET total_enrollment = total_enrollment + 1
WHERE class_id = @RegisterClassId;
...
-- Drop a course - Step 4: Update class enrollment count
UPDATE Bellini.Class
SET total_enrollment = total_enrollment - 1
WHERE class_id = @DropClassId;
...
-- Add a course - Step 4: Update class enrollment count
UPDATE Bellini.Class
SET total_enrollment = total_enrollment + 1
WHERE class_id = @AddClassId;
